...
// Seed assignments on first run
const SEED_ASSIGNMENTS = [
  {
    title: 'Basic Employee SELECT',
    description: 'Practice fetching employee records with basic SELECT and WHERE.',
    difficulty: 'beginner',
    question: 'Retrieve the names and salaries of all employees who work in the Engineering department, ordered by salary in descending order.',
    requirements: [
    ...
    tableSchemas: [
      {
        ...
        columns: [
          ...
          { name: 'department', type: 'VARCHAR(100)', description: 'Department name' },
          { name: 'salary', type: 'NUMERIC(10,2)', description: 'Annual salary' },
          { name: 'hire_date', type: 'DATE', description: 'Date of hire' },
          { name: 'manager_id', type: 'INT', description: 'ID of manager (self-ref)' },
        ],
      },
    ],
  ...
  },
  {
    ...
    description: 'Use GROUP BY and aggregate functions to analyze employee data.',
    difficulty: 'beginner',
    question: 'Find the average salary for each department. Show the department name and average salary, ordered by average salary from highest to lowest.',
    requirements: [
    ...
    tableSchemas: [
      {
        ...
        columns: [
          ...
          { name: 'salary', type: 'NUMERIC(10,2)', description: 'Annual salary' },
          { name: 'hire_date', type: 'DATE', description: 'Date of hire' },
          { name: 'manager_id', type: 'INT', description: 'Self-referencing manager ID' },
        ],
      },
    ],
  ...
  },
  {
    ...
    question: 'Calculate the total revenue (quantity × price) for each product listed in the orders table. Show only products with total revenue above $500. Display the product name and total revenue, ordered by total revenue descending.',
    requirements: [
    ...
    tableSchemas: [
      {
        ...
        columns: [
          ...
          { name: 'product', type: 'VARCHAR(100)', description: 'Product ordered' },
  ...
  },
  {
    ...
    difficulty: 'intermediate',
    question: 'List all employees along with their manager\'s name. If an employee has no manager, show NULL. Display employee name, their department, and manager name. Order by employee name alphabetically.',
    requirements: [
    ...
    tableSchemas: [
      {
        ...
        columns: [
          ...
          { name: 'salary', type: 'NUMERIC(10,2)', description: 'Annual salary' },
          { name: 'hire_date', type: 'DATE', description: 'Date of hire' },
          { name: 'manager_id', type: 'INT', description: 'References id of manager in same table' },
        ],
      },
    ],
  ...
  },
  {
    ...
    description: 'Use window functions or subqueries to find the top scorer in each subject.',
    difficulty: 'advanced',
    question: 'Find the student with the highest score in each subject. Display student name, subject, and their score. Handle ties by showing all tied top-scorers.',
    requirements: [
    ...
    tableSchemas: [
      {
        ...
        columns: [
          ...
          { name: 'subject', type: 'VARCHAR(100)', description: 'Subject name' },
  ...
  },
  {
    ...
    difficulty: 'advanced',
    question: 'Generate a monthly sales summary for 2024. For each month, show the total number of orders, total revenue, and the most ordered product (by quantity). Display month number, order count, total revenue, and top product.',
    requirements: [
...
exports.getAssignmentById = async (req, res) => {
  try {
    ...
    // Fetch sample data for relevant tables
    const sampleData = {};
